          ...
          <div className="col-12 col-md-6 py-0 px-4">
            <div className="intro py-5 my-0 my-md-5 margin_0">
              ...
              <p className="intro_para pb-2">
                IIC Academy is the training arm of IIC Technologies, which brings over two decades of global expertise in geospatial projects and services.
              </p>
        ...
        <div className="row pt-4 justify-content-center">
          <div className="col-12 col-md-8 d-flex align-items-center">
            <div className="py-4">
              ...
              from short term fundamental to long term advanced levels. Using best practices, the academy empowers its learners to be industry-ready and succeed at the workplace. </p>
            </div>
          </div>
        </div>
        <div className="row py-4 justify-content-between">
          <div className="col-12 col-lg-5 d-flex align-items-center bg_navy rounded mb-4">
            <div className="px-4 py-5 col-12">
              ...
              <h2 className="mb-3 white_text ">s5 Marine Geospatial </h2>
              <p className="white_text pr-2">
               The purpose of the IIC S-8 Category B current program is to prepare candidates with the theoretical and practical competencies necessary to effectively carry out the planning and izmplementation of nautical ...
              </p>
              <div className="mt-4 mb-2"><a href="../iicacademy/theprogram.html" target="_blank" rel="noreferrer" className="redbtn_see">Learn More</a></div>

            </div>
            <div className="position-absolute bg_lightblue px-3 py-2 " style={{right:"0",  top:"300px"}}><h4 className="white_text m-0">Sept. 6, 2022</h4></div>
          </div> 
          <div className="col-12 col-lg-5 d-flex align-items-center bg_navy rounded mb-4">
            <div className="px-4 py-5 col-12">
              <div className="mb-4 w-100 row-4 " style={{height: '350px'}}>
              ...
              <h2 className="mb-3 white_text">s8 Hydrographic Surveying</h2>
              <p className="white_text pr-2">
                The purpose of the IIC S-8 Category B current program is to prepare candidates with the theoretical and practical competencies necessary to effectively carry out the planning and izmplementation of nautical ...
              </p>
              <div className="mt-4 mb-2"><a href="../S8B/S8BProgram.html" target="_blank" rel="noreferrer" className="redbtn_see">Learn More</a></div>
            </div>
            <div className="position-absolute bg_lightblue px-3 py-2 " style={{right:"0",  top:"300px"}}><h4 className="white_text m-0">Sept. 12, 2022</h4></div>
          </div>    
        </div>
      </div>
    </section>
